...
def generate_initial_chat_function(kernel) -> sk.KernelFunctionBase:
    system_message = """
...
chat_function = generate_initial_chat_function(kernel)
...
def generate_new_chat_function_using_index(kernel: sk.Kernel, index_name: str) -> sk.KernelFunctionBase:
